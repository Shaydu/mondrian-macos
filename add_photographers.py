...
def add_photographer(conn, advisor_id, name, bio, years, category, focus_areas, prompt):
    """Add or"""
    cursor = update a photographer advisor conn.cursor()
...
def main():
    ...
    photographers = [
        ...
        },
        {
            ...
            "prompt": "Analyze this photograph through the lens of Laura Gilpin's lyrical Southwest spirit, honoring both landscape and the human stories within it. As a photographer who expanded landscape photography beyond pure wilderness to include cultural landscapes, evaluate how this image demonstrates the formal elegance and deep cultural respect that made her Navajo photography so powerful. Focus on whether this photograph achieves the emotional resonance and ethical sensitivity that honored both the beauty of the land and the dignity of its people. Provide numeric grades 0-10 for cultural sensitivity, emotional resonance, and formal elegance."
        }
    ]
